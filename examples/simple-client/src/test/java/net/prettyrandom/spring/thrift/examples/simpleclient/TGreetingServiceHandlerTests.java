...
import net.prettyrandom.spring.thrift.examples.simpleclient.configuration.CountingAspect;
import net.prettyrandom.spring.thrift.examples.simpleclient.configuration.TestAspectConfiguration;
...
import static net.prettyrandom.spring.thrift.examples.simpleclient.TGreetingServiceController.*;
